...
def model_fusion(depth=2,noise_ratio=0.5, gate=True,num_em=True):
    prototype_all = torch.load("songci_prototype.pt",map_location="cuda") # from patch-level pretraining and have already padding ! https://huggingface.co/shenxiaochen/SongCi/blob/main/songci_prototype.pt
