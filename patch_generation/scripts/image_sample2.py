...
from guided_diffusion.get_sl_models import get_model
...
def main():
    ...
    logger.configure("./sample_choose220_26_new/")
    # Load SSL model
    if args.feat_cond:
    ...
    np.savez(args.out_dir+'/'+args.name+"_data"+'.npz', arr)
...
def create_argparser():
    defaults = dict(
        ...
        type_model="my_model",
        use_head=False,
        model_path="/home/wangzhenyuan/diffu_path/guided-diffusion-main/log_220/ema_0.9999_260000.pt",
        out_dir="/home/wangzhenyuan/diffu_path/guided-diffusion-main/sample_choose220_26_new",
        name="sample"
    )
