...
def main():
    ...
    logger.configure("./sample_choose220_20_new/")
    # Load SSL model
    if args.feat_cond:
...
def create_argparser():
    defaults = dict(
        ...
        type_model="my_model",
        use_head=False,
        model_path="/home/wangzhenyuan/diffu_path/guided-diffusion-main/log_220/ema_0.9999_200000.pt",
        out_dir="/home/wangzhenyuan/diffu_path/guided-diffusion-main/sample_choose220_20_new",
        name="sample"
    )
