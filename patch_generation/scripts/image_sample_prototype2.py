...
def main():
    ...
    logger.configure("./sample_small2/")
    # Load SSL model
    if args.feat_cond:
...
def create_argparser():
    defaults = dict(
        ...
        type_model="my_model",
        use_head=False,
        model_path="/home/wangzhenyuan/diffu_path/guided-diffusion-main/log_220_p/ema_0.9999_300000.pt",
        out_dir="/home/wangzhenyuan/diffu_path/guided-diffusion-main/sample_small2",
